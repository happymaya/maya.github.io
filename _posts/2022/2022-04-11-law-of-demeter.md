...
![将顾客“获取钱包”的动作修改为“支付账单”，代码修改前后对比](https://images.happymaya.cn/assert/design-patterns/lod-01.png)
...
![将收银员“获取顾客钱包”的动作，修改为“收取顾客支付的钱并和账单比对”，代码对比](https://images.happymaya.cn/assert/design-patterns/lod-02.png) 这里收银员的动作就从获取钱包变为根据收到的钱进行判断的动作，如下所示：  
```java
/**
 * 收银员
 */
