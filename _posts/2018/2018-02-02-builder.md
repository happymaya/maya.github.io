...
建造者模式的通用 UML 图：
![建造者模式的通用 UML 图](https://images.happymaya.cn/assert/design-patterns/builder.jpg)
...
![](https://images.happymaya.cn/assert/design-patterns/builder-times.jpg)
...
![JDK 类库中 Appendable 接口实现建造者模式的优秀范例](https://images.happymaya.cn/assert/design-patterns/builder-jdk-example.jpg)那么问题来了，
